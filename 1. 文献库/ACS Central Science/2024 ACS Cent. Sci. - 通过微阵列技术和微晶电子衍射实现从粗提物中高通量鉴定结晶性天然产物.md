...
**2024 ACS Cent. Sci. | 通过微阵列技术和微晶电子衍射实现从粗提物中高通量鉴定结晶性天然产物**

![...](..\ACS%20Central%20Science\images\2024%20ACS%20Cent.%20Sci.%20-%20通过微阵列技术和微晶电子衍射实现从粗提物中高通量鉴定结晶性天然产物.001.png)
...
![...](..\ACS%20Central%20Science\images\2024%20ACS%20Cent.%20Sci.%20-%20通过微阵列技术和微晶电子衍射实现从粗提物中高通量鉴定结晶性天然产物.002.png)
...
![...](..\ACS%20Central%20Science\images\2024%20ACS%20Cent.%20Sci.%20-%20通过微阵列技术和微晶电子衍射实现从粗提物中高通量鉴定结晶性天然产物.003.png)

- **Figure 1C** 直观地展示了 ArrayED 的核心思想：将 96 个 HPLC 馏分点样到**一个** TEM 网格上，整个过程仅需 4-8 小时。
- **Figure 2A** 展示了微阵列点样仪和最终制备出的、布满样品点的 TEM 网格实物图。

![...](..\ACS%20Central%20Science\images\2024%20ACS%20Cent.%20Sci.%20-%20通过微阵列技术和微晶电子衍射实现从粗提物中高通量鉴定结晶性天然产物.004.png)
...
2. 案例来源涵盖植物（美洲紫珠 *Callicarpa americana*）、真菌（*Trichoderma afroharzianum*, *Preitonia sp.* 等）和海洋生物（红藻 *Halymenia sp.*）。
...
![...](..\ACS%20Central%20Science\images\2024%20ACS%20Cent.%20Sci.%20-%20通过微阵列技术和微晶电子衍射实现从粗提物中高通量鉴定结晶性天然产物.005.png)

- **Figure 4** 以真菌 *Trichoderma afroharzianum* 的提取物为例，展示了一个精彩的发现过程。HPLC 图谱显示在一个复杂的峰簇中，相邻的三个馏分 (E7, E8, E9) 都产生了高质量的衍射。结构解析表明，E7 是纯的 pachybasin (**10**)，E9 是纯的 chrysophanol (**11**)，而中间的 E8 则是这两种结构高度相似的化合物的**共晶 (co-crystal)**。这一发现揭示了 HPLC 的时间分辨能力如何影响结晶过程，并证明了 ArrayED 能够解析复杂的共晶结构。

![...](..\ACS%20Central%20Science\images\2024%20ACS%20Cent.%20Sci.%20-%20通过微阵列技术和微晶电子衍射实现从粗提物中高通量鉴定结晶性天然产物.006.png)

- **Figure 5A** 展示了从海洋红藻中解析一个复杂糖脂 (**15**) 的案例。该案例中，microED 成功地解决了 NMR 无法确定的脂肪酸链连接位点问题，展示了 microED 与传统波谱学方法的互补性。

![...](..\ACS%20Central%20Science\images\2024%20ACS%20Cent.%20Sci.%20-%20通过微阵列技术和微晶电子衍射实现从粗提物中高通量鉴定结晶性天然产物.007.png)

- **一个关键发现**：在对 *Preitonia sp.* 的分析中，成功解析了甘露醇 (**12**) 的结构。甘露醇是一个没有 UV 吸收的糖醇，如果采用传统的 UV 指导的分离方法，这个化合物很可能会被完全忽略。这凸显了 ArrayED 这种“无偏见”筛选方法的优势。
...
4. **结果**：microED 分析显示：
- E7 点（峰前沿）的晶体是纯的 pachybasin (**10**)。
- E9 点（峰后沿）的晶体是纯的 chrysophanol (**11**)。
- 而 E8 点（峰尖）的晶体则是这两种分子的**共晶**。
