...
**通讯作者**：K. N. Houk, Kenji Watanabe (渡边贤二)
...
基于前体转化实验，推测 $\alpha/\beta$ 水解酶 PyaF 负责关键的成环步骤。在大肠杆菌中表达纯化 PyaF，通过体外酶活实验（*in vitro* assay）直接证实其催化双环氧化物底物生成稠合双环产物的能力。
...
#### 实验结果与分析
*   **基因簇锁定**：在 *Pyrenula* sp. 基因组中筛选出 13 个候选 PKS 基因簇，RT-PCR 显示 *pks6* 在产物生成条件下高表达（Figure S1）。该基因簇（命名为 *pya*）包含 PKS、还原酶、P450s 和 $\alpha/\beta$ 水解酶（Table 1）。
*   **P450 功能验证**：
